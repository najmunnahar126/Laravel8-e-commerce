	<!--main area-->
	<main id="main" class="main-site" wire:ignore>
		<style>
			.regprice{
				font-weight:300;
		...
		<div class="container" wire:ignore>
			...
			<div class="wrap-breadcrumb" wire:ignore>
				<ul>
			...
			<div class="row" wire:ignore>
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area" wire:ignore>
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar" wire:ignore>
					...
					<div class="widget mercado-widget widget-product" wire:ignore>
